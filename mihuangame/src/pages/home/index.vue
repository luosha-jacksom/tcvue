      ...
      <div class="HomeView">
        ...
        <div class="litsBox">
          ...
          <div class="listItem" v-for="(item,index) in list" :key="index">
            <div class="left">
              <img class="leftImg" :src="item.img" alt="" srcset="">
            </div>
            <div class="right">
              <div class="name"> 
                <div class="renzheng"><img src="@/assets/img/v.png" alt="" srcset=""> 认证</div>
                {{ item.name }}
              </div>
              <div class="labels">
                <div class="labelsItem" v-for="(item2,index2) in item.labels" :key="index2">{{ item2 }}</div>
              </div>
              <div class="info">
                <div class="infoItem">{{ item.age }}岁</div>
                <div class="infoItem">{{ item.height }}厘米</div>
                <div class="infoItem">{{ item.cup }}杯</div>
              </div>
              <div class="bottomBtn">马上去和她约会。</div>
            </div>
          </div>
        </div>
      </div>
...
export default {
  data() {
    return {
      ...
      list:[
        {
          img:require('@/assets/img/introduction_badge.926d8bbd.png'),
          name:"衣姆哒",
          age:"23",
          height:'169',
          cup:'36-26-36',
          labels:['美丽的女孩','苗条','白皮肤','真正的女人']
        },
        {
          img:require('@/assets/img/introduction_badge.926d8bbd.png'),
          name:"衣姆哒",
...
.blur-bg2{
  ...
  left: 0;
  top: 0;
  background: linear-gradient(to right, #000, #121212,#4D3F31);
  // background:#000;
  background-size: cover;
  filter: blur(10px);
  -webkit-filter: blur(10px); /* 为了兼容 Webkit 内核的浏览器 */
